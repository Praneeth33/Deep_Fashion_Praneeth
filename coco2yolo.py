...
def convert_coco_to_yolo_segmentation(json_file, folder_name="labels"):
    ...
    Args:
        ...
        folder_name (str, optional): Name of the folder to store YOLO segmentation annotations.
                                     Defaults to "labels".
    """
    # Load the JSON file
    ...
    # Create a folder to store YOLO segmentation annotations
...
if __name__ == "__main__":
    json_file = "minicoco.json"  # JSON file
    output_dir = "data/labels2"  # Folder
    convert_coco_to_yolo_segmentation(json_file, output_dir)
